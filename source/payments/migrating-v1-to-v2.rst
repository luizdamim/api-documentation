...
* New features such as :doc:`Mollie Components </components/overview>`, :doc:`place a hold for a payment </payments/place-a-hold-for-a-payment>`, 
and wallets such as :doc:`/wallets/applepay` are only available in the Mollie API v2.
